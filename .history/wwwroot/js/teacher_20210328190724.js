...
// $("#addExamBtn").click(onAddExamBtnClick);
///---------------------------------------
...
function onAddExamBtnClick() {
	...
	//if (cnt > 0) {
	var ret =
		'<td class="title-column2">' +
		'<input type="text" id="title" />' +
		"</td>" +
		'<td class="startDate-column3">' +
		'<input type="date" id="startDate" />' +
		"</td>" +
		'<td class="duration-column4">' +
		'<input type="number" id="duration" />' +
		"</td>" +
		'<td class="TeacherId-column5">' +
		'<input type="text" id="TeacherId" />' +
		"</td>" +
		'<td class="empty-column6">' +
		"</td>" +
		'<td class="submit-column7">' +
		'<input type="submit" onclick="return fillTable();" />' +
		"</td>";

	$("#add-exam-row").append(ret);
	document.getElementById("addExamBtn").disabled = true;
	//} else {
	//	cnt++;
	//}

	// $(".title-column2")[0].style.display = "block";
	// $(".startDate-column3")[0].style.display = "block";
	// $(".duration-column4")[0].style.display = "block";
	// $(".TeacherId-column5")[0].style.display = "block";
	// $(".empty-column6")[0].style.display = "block";
	//$(".submit-column7")[0].style.display = "block";

	//https://localhost:5001/teacherPage.html?3
	// var QuestionModel = {
	//     Question: questionVal,
	//     Choices: choicesVal,
	//     Correct: answerVal,
